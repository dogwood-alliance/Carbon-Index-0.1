...
```{r}
play<- subset(fci.data, State== "Florida")

model.data<- subset(state.data, Stand_Age!= "Total")
#ageclass$Stand_Age.dummy<- C(ageclass$Stand_Age, treatment)

#model.matrix(~Stand_Age, data= ageclass)

#print(ageclass$Stand_Age.dummy)
#ageclass

#C(ageclass$Stand_Age, treatment)
